...
def test_display_history_empty(capsys):
    ...
    # matches line 60 of calculator.py: print("No calculations performed yet.")
...
def test_calculator_multiplication(monkeypatch, capsys):
    ...
    # matches this: f"{self.__class__.__name__}: {self.a} {operation_name} {self.b} = {result}"
...
def test_calculator_division_by_zero(monkeypatch, capsys):
    ...
    # matches this line: print("Cannot divide by zerooo") in calculator.py
...
def test_calculator_unsupported_operation(monkeypatch, capsys):
    ...
    # Assert
    captured = capsys.readouterr()
    assert "Unsupported calculation type: 'modulus'." in captured.out # raise ValueError(f"Unsupported calculation type: in calculation.py
    assert "Type 'help' to see the list of supported operations." in captured.out # print("Type 'help' to see the list of supported operations.\n") in calculator.py
